...
class _RegrasScreenState extends State<RegrasScreen> {
  ...
  Future<void> calcularRegras() async {
    final uri = Uri.parse('http://localhost:3000/api/regras');
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'tempoContribuicao': int.tryParse(contribuicaoController.text) ?? 0,
          'sexo': sexo,
          'categoria': categoria,
        }),
      );
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(value: 'deficiencia', child: Text('Deficiência')),
                    DropdownMenuItem(value: 'rural', child: Text('Rural')),
                    DropdownMenuItem(value: 'programada', child: Text('Programada')),
                    DropdownMenuItem(value: 'incapacidade', child: Text('Incapacidade')),
                  ],
